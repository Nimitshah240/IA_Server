package com.ia.server.dashboard.aop;
...
@Aspect
@Component
public class DashboardAop {

    private static final Logger logger = LoggerFactory.getLogger(DashboardAop.class);

    @Pointcut("execution(* com.ia.server.dashboard.*.*.*(..))")
